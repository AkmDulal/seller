...
@Component({
  selector: 'app-business-advisor',
  templateUrl: './business-advisor.component.html',
  styleUrls: ['./business-advisor.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BusinessAdvisorComponent implements OnInit {
